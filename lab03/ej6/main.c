...
/* Con punteros si funciona mas rapido(0,01 aprox, sin punteros 0,05 aprox).
Son mas eficientes los intercambios porque se accede a la estructura (especificamente a la seccion rank)
mas rapidamente, puesto que tenemos punteros que directamente acceden a esa direccion de memoria. 
Si no estuviera la funcion destroy tendriamos direcciones de memoria reservadas aun despues de terminar de
